# -*- encoding: utf-8 -*-
# stub: rubycritic 3.2.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<cucumber>.freeze, [">= 2.2.0", "~> 2.2"])
      ...
      s.add_development_dependency(%q<rake>.freeze, [">= 11.0.0", "~> 11.0"])
      s.add_development_dependency(%q<rubocop>.freeze, ["~> 0.48.0"])
    else
      ...
      s.add_dependency(%q<cucumber>.freeze, [">= 2.2.0", "~> 2.2"])
      ...
      s.add_dependency(%q<rake>.freeze, [">= 11.0.0", "~> 11.0"])
      s.add_dependency(%q<rubocop>.freeze, ["~> 0.48.0"])
    end
  else
    s.add_dependency(%q<flay>.freeze, ["~> 2.8"])
    s.add_dependency(%q<flog>.freeze, ["~> 4.4"])
